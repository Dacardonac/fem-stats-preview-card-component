  ...
  return (
    <section className={s.stats}>
      ...
      <div className={s["stats__numbers"]}>
        <div className={s["stats__numbers--companies"]}>10k+ <span className={s["stats__numbers--light"]}>companies</span></div>
        <div className={s["stats__numbers--templates"]}>314 <span className={s["stats__numbers--light"]}>templates</span></div>
        <div className={s["stats__numbers--queries"]}>12m+ <span className={s["stats__numbers--light"]}>queries</span></div>
      </div>
    </section>
  );
}
